...
export default function SaveContactDashboard({
  phoneNumber,
  backToKeyBoard,
  inputDetailHandler,
  ...
  return (
    <div className="save-contact-dashboard">
      <header>
        <button className="back-btn">
          <RiArrowDropLeftLine onClick={backToKeyBoard} />
        </button>
        <h3>Create new contact</h3>
        <a href="" onClick={submitContactDetailsHandler}>
          SAVE
        </a>
      </header>
      ...
      <form action="">
        <div className="create-contact-form-control">
          <button>
